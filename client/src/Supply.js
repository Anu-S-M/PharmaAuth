...
function Supply() {
    ...
    const handlerSubmitRMSsupply = async (event) => {
        ...
        try {
            const reciept = await SupplyChain.methods.RMSsupply(ID).send({ from: currentaccount });
            if (reciept) {
                loadBlockchaindata();
            }
        } catch (err) {
    ...
    const handlerSubmitManufacturing = async (event) => {
        event.preventDefault();
        try {
            const reciept = await SupplyChain.methods.Manufacturing(ID).send({ from: currentaccount });
            if (reciept) {
                loadBlockchaindata();
            }
        } catch (err) {
    ...
    const handlerSubmitDistribute = async (event) => {
        event.preventDefault();
        try {
            const reciept = await SupplyChain.methods.Distribute(ID).send({ from: currentaccount });
            if (reciept) {
                loadBlockchaindata();
            }
        } catch (err) {
    ...
    const handlerSubmitRetail = async (event) => {
        event.preventDefault();
        try {
            const reciept = await SupplyChain.methods.Retail(ID).send({ from: currentaccount });
            if (reciept) {
                loadBlockchaindata();
            }
        } catch (err) {
    ...
    const handlerSubmitSold = async (event) => {
        event.preventDefault();
        try {
            const reciept = await SupplyChain.methods.sold(ID).send({ from: currentaccount });
            if (reciept) {
                loadBlockchaindata();
            }
        } catch (err) {
