    ...
    return (
        <div>
            ...
            <form onSubmit={handlerSubmitRMS}>
                ...
                <input className="form-control-sm" type="text" onChange={handlerChangeNameRMS} placeholder="Name" required />
            ...
            <form onSubmit={handlerSubmitMAN}>
                ...
                <input className="form-control-sm" type="text" onChange={handlerChangeNameMAN} placeholder="Name" required />
            ...
            <form onSubmit={handlerSubmitDIS}>
                ...
                <input className="form-control-sm" type="text" onChange={handlerChangeNameDIS} placeholder="Name" required />
            ...
            <form onSubmit={handlerSubmitRET}>
                ...
                <input className="form-control-sm" type="text" onChange={handlerChangeNameRET} placeholder="Name" required />
