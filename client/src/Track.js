            ...
            <div className="container-xl">
                ...
                <section className="row">
                    ...
                    <article className="col-3">
                        ...
                        <p><b>ManufacturerID: </b>{MAN[MED[ID].MANid].id}</p>
            ...
            <div className="container-xl">
              <article className="col-4">
                ...
                <section className="row">
                    ...
                    <article className="col-3">
                        <h4><u>Raw Material Supplied by:</u></h4>
                        <p><b>Supplier ID:</b>{RMS[MED[ID].RMSid].id}</p>
                        <p><b>Name:</b> {RMS[MED[ID].RMSid].name}</p>
                        <p><b>Place: </b>{RMS[MED[ID].RMSid].place}</p>
                    </article>
                    ...
                    <article className="col-3">
                        ...
                        <p><b>Retailor ID: </b>{RET[MED[ID].RETid].id}</p>
                        <p><b>Name:</b> {RET[MED[ID].RETid].name}</p>
                        <p><b>Place: </b>{RET[MED[ID].RETid].place}</p>
                    </article>
                </section>
    ...
    return (
        <div>
            ...
            <form onSubmit={handlerSubmit}>
                <input className="form-control-sm" type="text" onChange={handlerChangeID} placeholder="Enter UID" required />
